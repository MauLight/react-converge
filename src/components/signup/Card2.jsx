...
export const Card2 = () => {
  return (
    <div className='shadow absolute w-[233.78px] h-[141.26px] bg-[#ffffff] rounded-lg z-20 left-[67%] p-3 pr-10'>
      <div className="flex w-full justify-start relative">
        <div className="w-[28px] h-[28px] rounded-full bg-[#87FF4F]"></div>
        <i className="fa-solid fa-bag-shopping  absolute top-[20%] left-[3.5%]"></i>
      </div>
      <p className='text-[12.39px]'>Revenue</p>
      <p className='text-[8.26px]'>Total Arm Band Generated the last 30 days</p>
      <h2 className='font-bold text-xl mt-2'>{'$ 3,500,345'}</h2>
